...
#include "../queryModel/mysqlquerymodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MySqlQueryModel_t, stringdata) + ofs \
...
const QMetaObject MySqlQueryModel::staticMetaObject = {
    { &QSqlQueryModel::staticMetaObject, qt_meta_stringdata_MySqlQueryModel.data,
      qt_meta_data_MySqlQueryModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MySqlQueryModel.stringdata))
